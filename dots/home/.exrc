...
imap  <Plug>Isurround
inoremap  u
imap \function mz:execute FunctionHeading()`zj$A
imap \program mz:execute FileHeading()`zjjjj$A
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set autoread
...
set tabpagemax=50
set tags=./tags;,./TAGS,tags,TAGS,doc/tags
set termguicolors
set ttimeout
set ttimeoutlen=100
